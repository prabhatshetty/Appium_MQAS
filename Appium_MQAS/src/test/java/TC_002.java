...
public class TC_002 {
	...
	public void launch() throws Throwable {
		...
		//tap on visit the website link
		driver.findElement(AppiumBy.xpath("//android.widget.Button[@text='Visit to the website to complete purchase']")).click();
		//used to switch from app to webview	
		Thread.sleep(2000);
		driver.context("WEBVIEW_com.androidsample.generalstore");
		
		driver.findElement(AppiumBy.xpath("//input[@aria-label='Google Search']")).sendKeys("green apple");
